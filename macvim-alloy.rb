...
class MacvimAlloy < Formula
  ...
  def install
    # MacVim doesn't have and require any Python package, unset PYTHONPATH.
    ...
    # to wait until MacVim is really able to link against different Pythons
    ...
    if build.with? "python" and build.with? "python3"
      ...
      # Force vim loading different Python at same time, may cause vim crash.
